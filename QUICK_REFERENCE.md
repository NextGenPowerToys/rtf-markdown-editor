...
# Open any markdown file with formulas like: 
```
`
# Open DevTools: F12
...
`
`     # Block integral
The value of  is approximately # Inline pi
`
## Browser DevTools Tips
- Open Console (F12 → Console tab)

- Filter by typing `[Math]` in filter box

- Check for conversion and rendering logs

- Look for any error messages

- Verify renderToString calls complete
...
- Open MATH_TEST_CONVERSION.md

- Check DevTools console (F12)

- Verify formulas render correctly

- Test with Hebrew/RTL content
